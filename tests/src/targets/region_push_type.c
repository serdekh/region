...
#define TEST_REGION_PUSH_TYPE_CASE_3(t)                                    \
    TestResult test_region_push_## t ##_case_3(RegionAPI *api)             \
    {                                                                      \
        TestResult result = {0};                                           \
                                                                           \
        RegionError error = REGION_ERROR_INIT;                             \
                                                                           \
        api->region_push_type(t, NULL, 0, &error);                         \
                                                                           \
        RT_TEST_RESULT_WRITE_INT(result,                                   \
            REGION_ERROR_TYPE_NONE, error.type);                           \
                                                                           \
        return result;                                                     \
    }                                                                      \

#define TEST_REGION_PUSH_TYPE_CASE_4(type)                                      \
...
TEST_REGION_PUSH_TYPE_CASE_3(int);
TEST_REGION_PUSH_TYPE_CASE_4(int);

TEST_REGION_PUSH_TYPE_CASE_1(float, "%f");
TEST_REGION_PUSH_TYPE_CASE_2(float, "%f");
TEST_REGION_PUSH_TYPE_CASE_3(float);
TEST_REGION_PUSH_TYPE_CASE_4(float);

TEST_REGION_PUSH_TYPE_CASE_1(double, "%f");
TEST_REGION_PUSH_TYPE_CASE_2(double, "%f");
TEST_REGION_PUSH_TYPE_CASE_3(double);
TEST_REGION_PUSH_TYPE_CASE_4(double);

TEST_REGION_PUSH_TYPE_CASE_1(char, "%c");
TEST_REGION_PUSH_TYPE_CASE_2(char, "%c");
TEST_REGION_PUSH_TYPE_CASE_3(char);
TEST_REGION_PUSH_TYPE_CASE_4(char);
