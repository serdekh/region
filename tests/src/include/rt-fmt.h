...
#define RT_TEST_RESULT_WRITE_INT(result, e, a) RT_TEST_RESULT_WRITE_FMT((result), "%d", (e), (a))
#define RT_TEST_RESULT_WRITE_FLOAT(result, e, a) RT_TEST_RESULT_WRITE_FMT((result), "%f", (e), (a))
