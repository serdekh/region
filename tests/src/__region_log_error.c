...
{
    TestContext context = tctx_get(REGION_ERROR_TYPE_INVALID_ARGUMENT, TESTOUT_FILE_PATH);
...
{
    TestContext context = tctx_get(REGION_ERROR_TYPE_NOT_ENOUGH_MEMORY, TESTOUT_FILE_PATH);
